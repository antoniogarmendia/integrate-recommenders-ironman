package uml.ifml.recommender.sirius.actions;
...
import uml.ifml.recommender.sirius.utils.RecommenderCase;
import uml.ifml.recommender.sirius.dialog.RecommenderData;
import static uml.ifml.recommender.sirius.utils.RecommenderUtils.*;
import java.util.Arrays;
import uml.ifml.recommender.sirius.dialog.RecommenderDialog;
			...
			if (targetEObject instanceof ViewContainer) {
				...
				if (dataFusion.size() != 0 ) {
					...
					final RecommenderDialog recDialog = new RecommenderDialog(PlatformUI.getWorkbench().getActiveWorkbenchWindow().getShell()
							, recServerToItemRecommenders, normalizeDataFusion, "ViewContainer", "Property");

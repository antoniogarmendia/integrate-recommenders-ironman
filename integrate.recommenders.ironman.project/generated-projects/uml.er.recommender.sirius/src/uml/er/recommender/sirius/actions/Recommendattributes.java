package uml.er.recommender.sirius.actions;
...
import uml.er.recommender.sirius.utils.RecommenderCase;
import uml.er.recommender.sirius.dialog.RecommenderData;
import static uml.er.recommender.sirius.utils.RecommenderUtils.*;
import java.util.Arrays;
import uml.er.recommender.sirius.dialog.RecommenderDialog;
			...
			if (targetEObject instanceof Entity) {
				...
				if (dataFusion.size() != 0 ) {
					...
					final RecommenderDialog recDialog = new RecommenderDialog(PlatformUI.getWorkbench().getActiveWorkbenchWindow().getShell()
							, recServerToItemRecommenders, normalizeDataFusion, "Entity", "Property");
